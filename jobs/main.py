...
def delivery_report(err,msg):
    if err is not None:
        print(f'Message delivery failure {err}')
    else:
...
def simulate_journey(producer, device_id):
    while True:
        ...
        traffic_camera_data = generate_traffic_camera_data(device_id,vehicle_data['timestamp'],vehicle_data['location'],'Nikon_cam')
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, 'Vehicle-aditsvet-dev')
